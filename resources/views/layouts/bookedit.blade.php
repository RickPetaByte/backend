        ...
        <div class="relative z-0 w-full mb-5 group">
            <div class="multiselect w-full">
                ...
                <div class="bg-white" style="display: none;" id="checkboxes">
                    <label for="romantic">
                    <input name="genres[]" class="m-2 form-control" type="checkbox" id="romantic" value="romantic" />Romantic</label>
                    <label for="action">
                    <input name="genres[]" class="m-2 form-control" type="checkbox" id="action" value="action" />Action</label>
                    <label for="Thriller">
                    <input name="genres[]" class="m-2 form-control" type="checkbox" id="thriller" value="thriller" />Thriller</label>
                    <label for="scifi">
                    <input name="genres[]" class="m-2 form-control" type="checkbox" id="scifi" value="scifi" />Sci-fi</label>
                    <label for="history">
                    <input name="genres[]" class="m-2 form-control" type="checkbox" id="history" value="history" />History</label>
                </div>
                <div class="relative z-0 w-full mb-5 mt-5 group">
                    <input type="file" name="book_image" id="floating_book_image" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=""/>
                    <label for="book_image" class="peer-focus:font-medium absolute text-sm text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Book Image</label>
                </div>
            </div>
        </div>
